        ...
        <div className="video-player" onClick={changeIcon}  >
            ...
            <div className="video-player__controls">
                ...
                <div className="video-player__scrubber-bar"> 
                    ...
                    <span className="video-player__time-left"> 0:00/{props.video.duration} </span>
                </div>
                <div className="video-player__side">
                    <img alt="fullscreen button" src={fullscreen} onClick={fullScreenVideo} className="video-player__fullscreen" /> 
